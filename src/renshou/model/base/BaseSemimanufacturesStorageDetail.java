...
public abstract class BaseSemimanufacturesStorageDetail<M extends BaseSemimanufacturesStorageDetail<M>> extends Model<M> implements IBean {
	...
	public M setSemimanufacturesStorageId(java.lang.Integer semimanufacturesStorageId) {
		set("semimanufactures_storage_id", semimanufacturesStorageId);
		return (M)this;
	}

	public java.lang.Integer getSemimanufacturesStorageId() {
		return get("semimanufactures_storage_id");
	}
